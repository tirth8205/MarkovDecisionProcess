...
xm = 'Enter the size of X: ';
MAX_X = input(xm)
ym = 'Enter the size of Y: ';
MAX_Y = input(ym)
...
%Terminals
%Winning point
xWin=MAX_X;%X Coordinate of the Winning point
yWin=MAX_Y;%Y Coordinate of the Winning point
...
yLos=6;%Y Coordinate of the Loss point
...
%Obstacles
xObs=card;%X Coordinate of the First Obstacle
yObs=atm;%Y Coordinate of the First Obstacle
